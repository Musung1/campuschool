                    ...
                    children: [
                      ...
                      Container(
                        child: Row(
                          ...
                          children: [
                            Text("공지사항", style: MyTextStyle.buttonText.copyWith(color: MyColor.primary, fontWeight: FontWeight.bold, fontSize: 18)),
                            Text(" 오늘 늦지마세요! ", style: MyTextStyle.buttonText.copyWith(color: MyColor.primary[300], fontWeight: FontWeight.bold)),
                          ],
                        ),
